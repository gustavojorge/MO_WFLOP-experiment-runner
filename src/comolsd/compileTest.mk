...
CXXFLAGS = -std=c++17 -g -Werror -O2 \
    ...
    -I./headers/global_modules/local_search \
...
SRC_FILES = \
    ...
    $(SRC_DIR)/adaptive_grid/ParetoSetLS.cpp \
...
MAIN_FILE = ${SRC_DIR}/global_modules/local_search/pareto_ls.cpp
